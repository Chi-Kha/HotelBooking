...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-light-grey w3-collapse w3-top" style="z-index:3;width:260px;padding-top: 50px" id="mySidebar">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
          <img src="images/classic1.jpg" alt="classic1" style="width: 100%;height: 450px">
      ...
      <div class="item">
        <img src="images/classic2.jpg" alt="classic2" style="width: 100%;height: 450px">
        <div class="carousel-caption">
          <h3>Dining Room</h3>
        </div>
      </div>
      ...
      <div class="item">
        <img src="images/classic3.jpg" alt="classic3" style="width: 100%;height: 450px">
        <div class="carousel-caption">
          <h3>Bedroom</h3>
      ...
      <div class="item">
        <img src="images/classic4.jpg" alt="classic4" style="width: 100%;height: 450px">
        <div class="carousel-caption">
          <h3>Living Room II</h3>
